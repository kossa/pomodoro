...
\`\`\`sh
gh release download $TAG --repo kossa/pomodoro --pattern 'Pomodoro-*.zip'
unzip -q Pomodoro-$VERSION.zip
xattr -dr com.apple.quarantine Pomodoro.app
mv Pomodoro.app /Applications/ && open /Applications/Pomodoro.app
\`\`\`
